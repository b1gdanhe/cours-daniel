...
<div class=" bg-white m-3 shadow-sm" style="height: calc(100dvh-70px);">
    <div
        ...
        <div class="w-50 bg-white   borderrounded mt-2">
            <form action="/etudiants/update" method="post" enctype="multipart/form-data">
                <input type="hidden" name="<?= $primaryKey ?>" value="<?= $etudiant[$primaryKey] ?>">
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="nom" class="form-label">Nom</label>
                            <input class="form-control" id="nom" type="text" name="nom" value="<?= $etudiant['nom'] ?? "" ?>">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="prenom" type="text" name="prenom" value="<?= $etudiant['prenom'] ?? "" ?>">
                            <div class="text-danger" style="font-size: 12px;">
                                <?= $errors['prenom'][0]  ?? "" ?>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="adresse" type="text" name="adresse" value="<?= $etudiant['adresse'] ?? "" ?>">
                            <div class="text-danger" style="font-size: 12px;">
                                <?= $errors['adresse'][0]  ?? "" ?>
                            </div>
                        </div>
