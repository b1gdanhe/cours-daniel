...
<div class=" bg-white m-3 shadow-sm" style="height: calc(100dvh-70px);">
    <div
        ...
        <div class="w-50 bg-white   borderrounded mt-2">
            <form action="/editeurs/update" method="post" enctype="multipart/form-data">
                <input type="hidden" name="<?= $primaryKey ?>" value="<?= $editeur[$primaryKey] ?>">
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="nom" class="form-label">Nom</label>
                            <input class="form-control" id="nom" type="text" name="nom" value="<?= $editeur['nom'] ?? "" ?>">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="adresse" type="text" name="adresse" value="<?= $editeur['adresse'] ?? "" ?>">
                            <div class="text-danger" style="font-size: 12px;">
                                <?= $errors['adresse'][0]  ?? "" ?>
                            </div>
                        </div>
