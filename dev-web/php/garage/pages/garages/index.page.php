                ...
                <?php else: ?>
                    ...
                    ?>
                        ...
                        <tr class="">
                            ...
                            <td scope="row"><?= $garage['name'] ?></td>
                            <td scope="row"><?= $garage['address'] ?></td>
                            <td scope="row">
                                <span
                                    class="badge rounded-pill text-bg-info"><?= $garage['phone'] ?></span>
                            </td>


                            <td scope="row">
                                <div>
                                    <a class="btn btn-primary" href="garages/show?id=<?= $garage['id'] ?>">
                                        Details
                                    </a>
                                    <a class="btn btn-warning" href="garages/edit?id=<?= $garage['id'] ?>">
                                        Modifier
                                    </a>
