                        ...
                        <div class="form-group">
                            ...
                            <select id="" class="form-select" name="garage_id">
                                <?php foreach ($garages as $garage): ?>
                                    <option <?= $car['garage_id'] === $garage['garage_id'] ? 'selected' : '' ?> value="<?= $garage['id'] ?>"><?= $garage['name'] ?></option>
                                <?php endforeach ?>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <select id="" class="form-select" name="client_id">
                                <?php foreach ($clients as $client): ?>
                                    <option <?= $car['client_id'] === $client['client_id'] ? 'selected' : '' ?> value="<?= $client['id'] ?>"><?= $client['last_name'] . ' ' . $client['first_name'] ?></option>
                                <?php endforeach ?>
                            </select>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="mark" type="text" value="<?= $car['mark'] ?>" name="mark">
                        </div>
                    </div>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="model" type="text" value="<?= $car['id'] ?>" name="model">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="enter_date" type="date" value="<?= $car['enter_date'] ?>" name="enter_date">
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label for="out_date" class="form-label">Date de sortie</label>
                            <input class="form-control" id="out_date" type="date" value="<?= $car['out_date'] ?>" name="out_date">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="year" type="date" value="<?= $car['year'] ?>" name="year">
                        </div>
                    </div>
                </div>
