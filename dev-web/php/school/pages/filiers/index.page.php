    ...
    <div
        ...
        <table
            ...
            <tbody>
                ...
                <?php else: ?>
                    <?php foreach ($filiers as $key => $filier):
                    ?>

                        <tr class="">
                            <td scope="row"><?= $filier['id'] ?></td>
                            <td scope="row">
                                <span
                                    class="badge rounded-pill text-bg-info"><?= $filier['sigle'] ?></span>
                            </td>
                            <td scope="row"><?= $filier['wording'] ?></td>



                            <td scope="row">
                                <div>
                                    <a class="btn btn-primary" href="filiers/show?id=<?= $filier['id'] ?>">
                                        Details
                                    </a>
                                    <a class="btn btn-warning" href="filiers/edit?id=<?= $filier['id'] ?>">
                                        Modifier
                                    </a>
                                    <form action="" method="post" style="display: inline;">
                                        <input type="hidden" name="id" value="<?= $filier['id'] ?>">
                                        <input class="btn btn-danger"
                                            type="submit"
                                            name="my-delete-filier-form"
                                            value="Delete filier" />
                                    </form>
