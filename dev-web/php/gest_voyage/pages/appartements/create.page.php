                ...
                <div class="row">
                            ...
                            <div class="mb-3">
                                ...
                                <select
                                    ...
                                    <?php foreach ($immeubles as $immeuble) : ?>
                                        <option value="<?= $immeuble['id'] ?? 1 ?>" <?= isset($post_datas['immeuble_id']) && $post_datas['immeuble_id'] == $immeuble['id']  ? 'selected' : "" ?>><?= $immeuble['name'] ?? "" ?></option>
                                    <?php endforeach ?>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="number" type="number" name="number" value="<?= $post_datas['number'] ?? "" ?>">
                            <div class="text-danger" style="font-size: 12px;">
                                <?= $errors['number'] ?? "" ?>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="level" type="number" name="level" value="<?= $post_datas['level'] ?? "" ?>">
                            <div class="text-danger" style="font-size: 12px;">
                                <?= $errors['level'] ?? "" ?>
                            </div>
                        </div>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="area" type="number" name="area" value="<?= $post_datas['area'] ?? "" ?>">
                            <div class="text-danger" style="font-size: 12px;">
                                <?= $errors['area'] ?? "" ?>
                            </div>
                        </div>
