                ...
                <?php else: ?>
                    ...
                    ?>
                        ...
                        <tr class="">
                            ...
                            <td scope="row"><?= $person['jobs'] ?></td>
                            <td scope="row"><?= $person['name'] ?>(<?= $person['number'] ?>)</td>


                            <td scope="row">
                                <div>
                                    <a class="btn btn-primary" href="persons/show?id=<?= $person['id'] ?>">
                                        Details
                                    </a>
                                    <a class="btn btn-warning" href="persons/edit?id=<?= $person['id'] ?>">
                                        Modifier
                                    </a>
